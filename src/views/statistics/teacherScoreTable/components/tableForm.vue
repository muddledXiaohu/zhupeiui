<template>
  <el-form :model="queryParams"
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4">
        <el-form-item label="学历" prop="zzz">
          <el-select v-model="queryParams.zzz" placeholder="请选择学历">
            <el-option
              v-for="item in unitSelectList"
              :key="item.value"
              :label="item.label"
      ...
      <el-col :span="4">
        <el-form-item label="带教教资" prop="eeee">
          <el-select v-model="queryParams.eeee" placeholder="请选择带教教资">
            <el-option
              v-for="item in unitSelectList"
              :key="item.value"
              :label="item.label"
